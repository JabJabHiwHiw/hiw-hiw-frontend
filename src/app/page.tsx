...
export default function Home() {
  return (
    <div>
      ...
      <h2 className="h2 font-bold">H2 Bold</h2>
      <h3 className="h3">H3 Regular</h3>
      <h3 className="h3 font-bold">H3 Bold</h3>
      <h4 className="h4">H4 Regular</h4>
      <h4 className="h4 font-bold">H4 Bold</h4>
      <h5 className="h5">H5 Regular</h5>
      <h5 className="h5 font-bold">H5 Bold</h5>
      <h6 className="h6">H6 Regular</h6>
      ...
      <div className="flex flex-col">
        ...
        <div className="bg-gray-100 w-full h-6" />
        <div className="bg-gray-200 w-full h-6" />
        <div className="bg-gray-300 w-full h-6" />
        <div className="bg-gray-400 w-full h-6" />
        <div className="bg-gray-500 w-full h-6" />
        <div className="bg-gray-600 w-full h-6" />
        <div className="bg-gray-700 w-full h-6" />
        <div className="bg-gray-800 w-full h-6" />
        <div className="bg-gray-900 w-full h-6" />
